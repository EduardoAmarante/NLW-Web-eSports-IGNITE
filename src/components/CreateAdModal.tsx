...
export function CreateAdModal(){
  ...
  return (
      <Dialog.Portal>
          ...
          <Dialog.Content className='fixed bg-[#2a2634] py-8 px-10 text-white top-1/4 left-1/2 -translate-x-1/2 -tranlate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
